...
abstract class Initial implements CollectionState {
...
abstract class Loading implements CollectionState {
    ...
    return _then(
      _$LoadedImpl(
        allBottles:
            null == allBottles
                ? _value._allBottles
                : allBottles // ignore: cast_nullable_to_non_nullable
                    as List<Bottle>,
        favorites:
            null == favorites
                ? _value._favorites
...
class _$LoadedImpl implements Loaded {
  const _$LoadedImpl({
    required final List<Bottle> allBottles,
    required final List<String> favorites,
    this.searchQuery = '',
    this.showOnlyFavorites = false,
  }) : _allBottles = allBottles,
       _favorites = favorites;

  final List<Bottle> _allBottles;
  @override
  List<Bottle> get allBottles {
    if (_allBottles is EqualUnmodifiableListView) return _allBottles;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_allBottles);
  }
  ...
  @override
  String toString() {
    return 'CollectionState.loaded(allBottles: $allBottles, favorites: $favorites, searchQuery: $searchQuery, showOnlyFavorites: $showOnlyFavorites)';
  }
  ...
  int get hashCode => Object.hash(
    runtimeType,
    const DeepCollectionEquality().hash(_allBottles),
  ...
  TResult when<TResult extends Object?>({
    ...
    return loaded(allBottles, favorites, searchQuery, showOnlyFavorites);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(allBottles, favorites, searchQuery, showOnlyFavorites);
  }
...
abstract class Loaded implements CollectionState {
...
abstract class Error implements CollectionState {
